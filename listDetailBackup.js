...
const DetailPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`http://skywayapi.ntechagent.com/detail/tget-images/${id}`);
        const result = await response.json();
        if (result.status === 'ok') {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`http://skywayapi.ntechagent.com/tget-images/${editData.id}`, {
        method: 'PUT',
        headers: {
...
// };
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`http://skywayapi.ntechagent.com/detail/tget-images?createdAt=${createdAt}`);
        const result = await response.json();
        if (result.status === 'ok') {
